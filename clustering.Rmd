...
each = get.siggenes(t, vars = "each", rsq=0)

see.genes(each$sig.genes$Time, k = 9)

cl = see.genes(each$sig.genes$Time2, k=9)

cl_1 = names(cl$cut[cl$cut == 1])


see.genes(each$sig.genes$Time3, k=9)
